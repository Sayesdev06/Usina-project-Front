...
const OrderPayments = (props) => {
  ...
  /**************Reducer data ******************* */
  const allPayment = useSelector((state) => state.order.arrayPayment);
  const arrayAllProvider = useSelector(
    (state) => state.userServices.arrayAllProvider
  );
  ...
  useEffect(() => {
    setLoading(true);
    searchAllPaymentOrder(attributeSearch);
    dispatch(actionCreator.getAllVendors());
  }, []);
  ...
  const searchAllPaymentOrder = (data) => {
    dispatch(actionCreator.getAllPaymentOrder(data, setLoading));
  };
        ...
        <>
          ...
          <Paper sx={{ width: "100%", overflow: "hidden" }}>
            <Grid container sx={{ p: 2 }} spacing={4}>
              <Grid item xs={12} md={2}>
                <FormControl fullWidth size="small">
                  ...
                  <TextField
                    ...
                    value={attributeSearch.orderId}
                    onChange={handleChangeAttributeSearch("orderId")}
                    inputProps={{ min: 0 }}
                  />
                </FormControl>
              </Grid>
              ...
              >
                <Button
                  onClick={() => searchAllPaymentOrder(attributeSearch)}
                  sx={{
                    color: "black",
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell sx={{ color: "#3a3541ad" }}>
                                ...
                                <a
                                  className="a-href"
                                  onClick={() => goToOrderDetails(row.orderId)}
                                >
                                  {row.orderId}
                                </a>{" "}
                              </TableCell>
                              ...
                              {/* <TableCell sx={{ color: "#3a3541ad" }}>
                                <a
                                  className="a-href text-over-flow-file-name"
                                  onClick={() => {
                                    openFile(row.order.file);
                                  }}
                                >
                                  {row.order && row.order.file
                                    ? getFileName(row.order.file)
                                    : ""}
                                </a>
                              </TableCell> */}
                              {/* <TableCell sx={{ color: "#3a3541ad" }}>
                                <a
                                  className="a-href text-over-flow-file-name"
                                  onClick={() => {
                                    openFile(row.order.orderFile);
                                  }}
                                >
                                  {row.order && row.order.orderFile
                                    ? getFileName(row.order.orderFile)
                                    : ""}
                                </a>
                              </TableCell> */}
                            </TableRow>
